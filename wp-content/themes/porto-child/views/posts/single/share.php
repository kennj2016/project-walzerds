...
if ( $porto_settings['share-enable'] && 'no' !== $share && ( 'yes' === $share || ( 'yes' !== $share && $porto_settings['post-share'] ) ) ) : ?>
	...
	<div class="<?php echo implode( ' ', $classes ); ?>">
		...
		<?php else : ?>
			<a class="wm-print" onclick="window.print()" href="#" title="Print"><img src="https://walzermelcher.com/img/print.svg" alt="print page" style="width:41px; margin: 0 20px;"></a>
			<?php get_template_part( 'share' ); ?>
		<?php endif; ?>
	</div>
	<?php
